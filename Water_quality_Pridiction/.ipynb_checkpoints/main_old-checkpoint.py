...
full_pipeline = ColumnTransformer([
    ...
    # For categorical columns, use OrdinalEncoder or OneHotEncoder instead of LabelEncoder in a pipeline
    # Here, using OrdinalEncoder for simplicity
    ("cat", StandardScaler(), object_cols)  # Replace with appropriate encoder if needed
])
